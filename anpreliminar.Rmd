...
+ $\mbox{inflation}_{t}$ taxa de inflação acumulada no mês captada pelo IPCA, levantada pelo IBGE.
...
<center>
![](C:/Users/rodri/Downloads/seriestemporais.png){width=80%}
</center>
...
<center>
![](C:/Users/rodri/Downloads/groupunitroottest.png){width=50%}
</center>
...
Somente o método de Im. Pesaran and Shin apontou essa condição. Os métodos de teste mais populares como Augmented Dickey-Fuller (ADF) e Phillips-Perron (PP) nos levam a concluir que a combinação de todas essas variáveis não se mostraram estacionárias
...
\widehat{IFI}_{t}=\alpha + \beta_{1}\mbox{exchange_rate}_{t}+\beta_{2}\mbox{interest_rate}_{t}+\beta_{3}+\mbox{inflation}_{t}+\mu_{t}
\end{equation}
...
<center>
![](C:/Users/rodri/Downloads/regrcointegrante.png){width=50%}
</center>

Nota-se o elevado grau de explicação e ajuste do modelo especificado medido pelo parâmetro $R^{2}$ denotando que cerca de 90\% das variações nas explicativas (variáveis de controle de política monetária) contribuem para as mudanças no IFI.


[explicar aqui o resultado apontado pelo teste $t$ na inflação]
...
<center>
![](C:/Users/rodri/Downloads/testeEGcointegracao.png){width=50%}
...
\Delta IFI_{t} = a_{0}+a_{1}\Delta\mbox{exchange_rate}_{t}+a_{2}\Delta\mbox{interest_rate}_{t}+\Delta a_{3}+\Delta\mbox{inflation}_{t}+a_{4}\widehat{\mu}_{t-1}+\epsilon_{t} 
...
<center>
![](C:/Users/rodri/Downloads/meccorrecaoerrosvec.png){width=50%}
</center>



Mostrando que alterações a curto prazo nos preços do Brent têm efeitos positivos significativos na dinâmica de inclusão financeira e que cerca de -1% da discrepância entre o valor efetivo e o valor de longo prazo, ou equilíbrio do IFI, é eliminada ou corrigida a cada mês. As elasticidades de longo prazo obtidas na equação de longo prazo (em especial maiores que 1 para a inflação) somam valores não-nulos para os efeitos em IFI confirmando a relação de longo prazo entre as séries temporais de controle monetário, considerando que as mudanças significativas no IFI se ajustariam a sua trajetória de crescimento a longo prazo com razoável rapidez após uma perturbação.

O gráfico a seguir ilustra os valores estimados e efetivos e os resíduos das regressões de curto e longo prazo: 

<center>
![](C:/Users/rodri/Downloads/vecvslp.png){width=80%}

</center>



### Resultados da modelagem VAR

[descrever aqui o passo a passo pra construção do VAR e VEC, testes JJ, estatística traço, critério Akaike, Schwarz, HQ e finalmente funções de impulso-resposta]
