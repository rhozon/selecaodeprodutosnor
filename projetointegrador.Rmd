...
Como exercício criei essa página na web escrita em RMarkdown contendo as interatividades gráficas para os exercícios aqui propostos. [Caso tenha interesse, baixe esse documento no formato .pdf editado com a integração $\LaTeX~$+R aqui.](https://github.com/rhozon/Projeto-Integrador-CD/blob/main/Atividades__Projeto_Integrador_de_Compet_ncias_em_CD.pdf)</small>
