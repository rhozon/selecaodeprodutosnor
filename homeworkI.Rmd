...
With different observations the $R^2$ are been incomparable (see the $n$ in the two estimated equations). The residual standard error consumed more degrees of freedom in model 2 and increased compared to model 1.
