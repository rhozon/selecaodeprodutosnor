...
Let $\widehat{\beta}_{0}$ and $\widehat{\beta}_{1}$ be the OLS intercept and slope estimators, respectively, and let $\overline{u}$ be the sample average of errors (not the residuals!).
...
[Shangai University of Finance](http://english.sufe.edu.cn/)
