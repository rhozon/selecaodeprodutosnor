---
title: "Projeto e Aplicação de Mineração de Dados"
...
## Descrição da atividade {.tabset .tabset-fade }

![](https://github.com/rhozon/datasets/raw/master/tarefa_PIT.png)
...
### Construção de features e do volume de negociação como variáveis explicativas
...
Inicialmente precisamos construir um dataframe contendo as variáveis necessárias
...
Pivoteamos o dataframe diário para criarmos a _feature_ dos ranges de tendências e inversões de trajetórias
...
CORN_df <- CORN_df %>%
 ...
 # trajetoria = as.character(Datas),
  
    trajetoria = 
    
    case_when(
      
      Datas == ymd("2010-06-09") & Datas <= ymd("2011-06-30") ~ "Tend. Alta",
      Datas == ymd("2011-09-31") & Datas <= ymd("2011-10-04") ~ "Tend. Queda",
      Datas == ymd("2011-10-05") & Datas <= ymd("2011-11-07") ~ "Tend. Alta",
      Datas == ymd("2011-11-08") & Datas <= ymd("2011-11-25") ~ "Tend. Queda",
  #   Datas == ymd("2011-08-31") & Datas <= ymd("2012-05-10") ~ "Tend. Queda",
      Datas == ymd("2012-05-10") & Datas <= ymd("2012-09-06") ~ "Tend. Alta",
      Datas == ymd("2012-09-07") & Datas <= ymd("2014-02-27") ~ "Tend. Queda",
      Datas == ymd("2014-02-28") & Datas <= ymd("2014-05-09") ~ "Tend. Alta",
      Datas == ymd("2014-05-10") & Datas <= ymd("2014-10-02") ~ "Tend. Queda",
      Datas == ymd("2014-10-03") & Datas <= ymd("2014-12-26") ~ "Tend. Alta",
      Datas == ymd("2014-12-27") & Datas <= ymd("2015-06-12") ~ "Tend. Alta",
      Datas == ymd("2015-06-13") & Datas <= ymd("2015-07-13") ~ "Tend. Alta",
      Datas == ymd("2015-07-14") & Datas <= ymd("2016-04-11") ~ "Tend. Queda",
      Datas == ymd("2016-04-12") & Datas <= ymd("2016-06-07") ~ "Tend. Alta",
      Datas == ymd("2016-06-08") & Datas <= ymd("2016-07-07") ~ "Tend. Queda",
      Datas == ymd("2016-07-08") & Datas <= ymd("2020-08-03") ~ "Tend. Queda",
      Datas == ymd("2020-08-04") & Datas <= ymd("2021-05-07") ~ "Tend. Alta",
      Datas == ymd("2021-05-08") & Datas <= ymd("2021-12-01") ~ "Tend. Alta",
...
HORIZON <- 30*24 # 24 meses à frente
...
model_fit_deepar <- deep_ar(
    id                    = "id",
    freq                  = "D", # D
    prediction_length     = 30*24, # 30 dias x 24 meses 
    lookback_length       = 30*48,
    epochs                = 5#,
#    learn_rate            = 0.01 
) %>%
...
```{r fig.width=9, fig.height=18, eval=FALSE }
