...
## Live YouTube {background-color="white" background-image="https://raw.githubusercontent.com/rhozon/Doutorado/main/cidamo_background_img_conteudo.png" background-size="1500px" background-repeat="no-repeat"}

&nbsp;

<center>

<iframe width="660" height="315" src="https://www.youtube.com/embed/E_VVJzJkmQQ?si=Ava3J59OJT8dcumw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
<font size = 5px>
 ...
 - [Link YouTube para essa apresentação AQUI](https://www.youtube.com/live/E_VVJzJkmQQ?si=bLv8VlUbAP7RQkX1)
