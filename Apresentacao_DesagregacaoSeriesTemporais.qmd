...
title-slide-attributes:
    data-background-image: "https://raw.githubusercontent.com/rhozon/Doutorado/main/background_UTFPRPUCPR.png"
...
format:
  revealjs:
    ...
    preview-links: auto
    css: styles.css
    footer: <a href="http://www.utfpr.edu.br/cursos/coordenacoes/stricto-sensu/ppgeps"> -- PPGEPS/UTFPR , Sep 21th 2023 -- </a> <a href="https://www.linkedin.com/in/rodrigohermontozon/"> [ Rodrigo Hermont Ozon -- PhD Researcher at PPGEPS/PUCPR] </a>
---
...
## Conteúdo {background-color="white" background-image="https://raw.githubusercontent.com/rhozon/Doutorado/main/background_UTFPRPUCPR.png" background-size="1500px" background-repeat="no-repeat"}
...
## Agregando dados de séries temporais {background-color="white" background-image="https://raw.githubusercontent.com/rhozon/Doutorado/main/background_UTFPRPUCPR.png" background-size="1500px" background-repeat="no-repeat"}
...
## Dividir x Desagregar dados de séries temporais {background-color="white" background-image="https://raw.githubusercontent.com/rhozon/Doutorado/main/background_UTFPRPUCPR.png" background-size="1500px" background-repeat="no-repeat"}
...
## Desagregação de séries temporais {background-color="white" background-image="https://raw.githubusercontent.com/rhozon/Doutorado/main/background_UTFPRPUCPR.png" background-size="1500px" background-repeat="no-repeat"}
...
## Critérios de Desagregação {background-color="white" background-image="https://raw.githubusercontent.com/rhozon/Doutorado/main/background_UTFPRPUCPR.png" background-size="1500px" background-repeat="no-repeat"}
...
## Um exemplo de séries desagregadas {background-color="white" background-image="https://raw.githubusercontent.com/rhozon/Doutorado/main/background_UTFPRPUCPR.png" background-size="1500px" background-repeat="no-repeat"}
...
## Mostrando mais exemplos... {background-color="white" background-image="https://raw.githubusercontent.com/rhozon/Doutorado/main/background_UTFPRPUCPR.png" background-size="1500px" background-repeat="no-repeat"}
...
$\Rightarrow$ Ao professor [Matheus Dal Molin Ribeiro](https://www.linkedin.com/in/matheus-dal-molin-ribeiro-8b581016a/) pela oportunidade de contribuir com os novos pesquisadores;
